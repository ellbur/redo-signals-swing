...
import java.awt.event.{ComponentEvent, ComponentListener, ItemEvent, ItemListener}
import java.awt.{Component, Dimension, Point}
import javax.swing.event.{ChangeEvent, ChangeListener, DocumentEvent, DocumentListener}
import javax.swing.text.JTextComponent
import javax.swing.{AbstractButton, JComboBox, JSlider}
...
trait SwingBridge { self: RedoSignalsSwing.type =>
